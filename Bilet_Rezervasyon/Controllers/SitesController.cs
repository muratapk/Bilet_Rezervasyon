...
namespace Bilet_Rezervasyon.Controllers
{
    public class SitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SiteId,SiteAd,Telefon,Mail,Adres")] Site site)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SiteId,SiteAd,Telefon,Mail,Adres")] Site site)
        {
            if (id != site.SiteId)
            {
                return NotFound();
